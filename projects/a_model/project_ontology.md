```mermaid
erDiagram
    DMP ||--o{ Dataset : describes
    DMP ||--o{ Contributor : has
    DMP ||--o{ Project : associated_with
    DMP ||--o{ Contact : managed_by
    DMP ||--o{ Funding : supported_by
    
    Dataset ||--o{ Distribution : has
    Dataset ||--o{ Metadata : follows
    Dataset ||--o{ Creator : created_by
    
    Project ||--o{ Funding : receives
    Project ||--o{ Affiliation : institutional_context
```
